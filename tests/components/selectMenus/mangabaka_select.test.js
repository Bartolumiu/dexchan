...
const titleSelect = require('../../../src/components/selectMenus/mangabaka_select');

describe('mangabaka_select', () => {
    ...
    beforeEach(() => {
        ...
        interaction = {
            ...
            values: ['testTitle'],
            component: new StringSelectMenuBuilder().setCustomId('mangabaka_select'),
            options: {
    ...
    it('should do nothing if the command does not exist', async () => {
        client.commands.delete('baka');
        await titleSelect.execute(interaction, client);
