...
const mangaSelect = require("../../../src/components/selectMenus/mangadex_select");

describe("mangadex_select", () => {
    ...
    beforeEach(() => {
        ...
        interaction = {
            ...
            values: ["testTitle"],
            component: new StringSelectMenuBuilder().setCustomId("mangadex_select"),
            options: {
