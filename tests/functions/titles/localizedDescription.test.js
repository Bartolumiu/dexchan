...
describe('getLocalizedDescription', () => {
    describe('MangaDex', () => {
        it('should return an english description for en-US locale (mapped to "en")', () => {
            const title = {
                attributes: {
                    description: { "en": "English description", "es-es": "Spanish description", "es-la": "Spanish (LA) description" }
                }
            };
            expect(getLocalizedDescription(title, 'mangadex', 'en-US')).toBe("English description");
        });

        it('should return a Spanish description when available for es-ES', () => {
            const title = {
                attributes: {
    ...
    describe('NamiComi', () => {
        it('should return an English description for en-US locale (mapped to "en")', () => {
            const title = {
                attributes: {
                    description: { "en": "English description", "es-es": "Spanish description", "es-419": "Spanish (419) description" }
                }
            };
        ...
        it('should return a Spanish description when available for es-ES (mapped to "es")', () => {
            const title = {
                attributes: {
                    description: { "es-es": "Spanish description", "en": "English description", "es-419": "Spanish (419) description" }
                }
            };
