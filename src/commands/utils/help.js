...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const footer = client.translate(locale, 'commands', 'help.response.footer', { commandName: `/${interaction.commandName}`, user: interaction.user.username }) || client.translate('en', 'commands', 'help.response.footer', { commandName: `/${interaction.commandName}`, user: interaction.user.username });
